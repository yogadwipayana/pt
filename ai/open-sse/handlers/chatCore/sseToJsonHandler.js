 ...
 */
export async function handleForcedSSEToJson({ providerResponse, sourceFormat, provider, model, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, apiKeyContext, onUsageCharge, clientRawRequest, onRequestSuccess, trackDone, appendLog }) {
