 ...
 */
export async function handleChatCore({ body, modelInfo, credentials, log, onCredentialsRefreshed, onRequestSuccess, onDisconnect, onUsageCharge, clientRawRequest, connectionId, userAgent, apiKey, apiKeyContext, ccFilterNaming, sourceFormatOverride, providerThinking }) {
