    ...
    <footer className="border-t border-[#3a2f27] bg-[#120f0d] pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <img src="/logo.svg" alt="Dwipa" className="size-6 rounded" />
              <h3 className="text-white text-lg font-bold">Dwipa</h3>
            </div>
        ...
        <div className="border-t border-[#3a2f27] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">© 2025 Dwipa. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
