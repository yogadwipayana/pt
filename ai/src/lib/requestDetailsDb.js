...
// Detect cloud environment more robustly — caches alone is not enough because
// Next.js App Router exposes an unstable_cache function globally.
const isCloud = (typeof caches !== "undefined" && typeof caches === "object" && typeof EdgeRuntime !== "undefined") ||
  (typeof caches !== "undefined" && typeof caches === "object" && typeof importScripts === "function");
...
async function getObservabilityConfig() {
  ...
  try {
    ...
    const explicitEnabled = typeof settings.enableObservability === "boolean"
      ? settings.enableObservability
      : typeof settings.observabilityEnabled === "boolean"
        ? settings.observabilityEnabled
        : null;
    const enabled = explicitEnabled !== null ? explicitEnabled : envEnabled;
...
async function flushToDatabase() {
  if (!DB_FILE || isFlushing || writeBuffer.length === 0) return;
