...
export function logUsage(provider, usage, model = null, connectionId = null, apiKey = null) {
  ...
  // Save to usage DB — streaming usage is recorded once by saveUsageStats
  // (called from onStreamComplete in streamingHandler.js) with the chargedCost.
  // We only write the text log here to avoid double-counting raw vs discounted cost.
  const tokens = {
